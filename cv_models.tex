...
We use our quality metrics to perform \emph{coarse model analysis}, comparing and contrasting the three (or four, if ResNet-1K is a distinct series) model series, permitting us to predict trends in model quality for these series. 
