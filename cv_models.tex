...
%MM%    \begin{figure}[t]
%MM%        \centering
%MM%        \subfigure[ ResNet, $\alpha$-Norm ]{
%MM%            %\includegraphics[width=4.2cm]{img/ResNet_logpnorm_accs.png}
%MM%            %\includegraphics[width=4.0cm]{img/ResNet_logpnorm_accs.png}
%MM%            \includegraphics[width=2.6cm]{img/ResNet_logpnorm_accs.png}
%MM%            \label{fig:resnet-accuracy}
%MM%        }
%MM%        %\qquad
%MM%        \subfigure[ ResNet-1K, $\alpha$-Norm ]{
%MM%            %\includegraphics[width=4.5cm]{img/ResNet-1K_logpnorm_accs.png}
%MM%            %\includegraphics[width=4.0cm]{img/ResNet-1K_logpnorm_accs.png}
%MM%            \includegraphics[width=2.6cm]{img/ResNet-1K_logpnorm_accs.png}
%MM%            \label{fig:resnet1k-accuracy}
%MM%        }
%MM%        %\qquad
%MM%        \subfigure[ DenseNet, $\alpha$-Norm ]{
%MM%            %\includegraphics[width=4.4cm]{img/DenseNet_logpnorm_accs.png}
%MM%            %\includegraphics[width=4.0cm]{img/DenseNet_logpnorm_accs.png}
%MM%            \includegraphics[width=2.6cm]{img/DenseNet_logpnorm_accs.png}
%MM%            \label{fig:densenet-accuracy}
%MM%        }
%MM%        \caption{$\alpha$-Norm versus reported Top1 Error for  ResNet, ResNet-1K, and DenseNet. Corresponding VGG results in Figure~\ref{fig:vgg-pnorm}.  }
%MM%        \label{fig:cv2-accuracy}
%MM%    \end{figure}
%MM%    
%MM%    \begin{figure}[t]
%MM%        \centering
%MM%        \subfigure[ VGG ]{
%MM%            %\includegraphics[width=4.5cm]{img/VGG_fnl_alpha_depth.png} 
%MM%            %\includegraphics[width=4.0cm]{img/VGG_fnl_alpha_depth.png} 
%MM%            \includegraphics[width=2.6cm]{img/VGG_fnl_alpha_depth.png} 
%MM%                    \label{fig:vgg-alpha-layers}
%MM%        }
%MM%        %\qquad
%MM%        \subfigure[ ResNet-1K ]{
%MM%            %\includegraphics[width=4.5cm]{img/ResNet_fnl_alpha_depth.png} 
%MM%            %\includegraphics[width=4.0cm]{img/ResNet_fnl_alpha_depth.png} 
%MM%            \includegraphics[width=2.6cm]{img/ResNet_fnl_alpha_depth.png} 
%MM%            \label{fig:resnet-alpha-layer}
%MM%        }
%MM%        %\qquad
%MM%        \subfigure[ DenseNet ]{
%MM%            %\includegraphics[width=4.5cm]{img/DenseNet_fnl_alpha_depth.png} 
%MM%            %\includegraphics[width=4.0cm]{img/DenseNet_fnl_alpha_depth.png} 
%MM%            \includegraphics[width=2.6cm]{img/DenseNet_fnl_alpha_depth.png} 
%MM%            \label{fig:densenet-alpha-layer}
%MM%        }
%MM%        \caption{Layer Analysis. 
%MM%                 PL exponent $\alpha$ versus layer id, for VGG, ResNet-1K, and DenseNet models.  
%MM%                 (Y axes on each plot are different.)  
%MM%                 ResNet-1K exhibits different and much more stable behavior across layers.
%MM%                 This contrasts with how VGG gets gradually worse in deeper layers and how DenseNet is worse and much more erratic.  
%MM%                 In the text, we interpret this as quantifying a \emph{correlation flow} across the layers.  
%MM%                }
%MM%        \label{fig:3models-alpha-layers}
%MM%    \end{figure}
...
%MM%       \centering
       ...
       \caption{$\alpha$-Norm versus reported Top1 Error for  ResNet, ResNet-1K, and DenseNet. Corresponding VGG results in Figure~\ref{fig:vgg-pnorm}.  }
...
%                In the text, we interpret this as quantifying a \emph{correlation flow} across the layers.  
               }
...
To understand these results, recall the differences---in particular, the number of residual connections---between the VGG, ResNet, and DenseNet architectures.
...
\michael{FIX: Do we have something backwards here: where we observed that the average norm to increase with decreasing test error (as it ``should'' not), whereas the average PL exponent $\alpha$ decreases (as ``expected'' from HT-SR Theory).  }
...
\michael{FIX: Where is that increase?  Or is that a typo?}
