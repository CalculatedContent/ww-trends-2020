...
\charles{GPT2 (small) is GPT--I think they are the same model--but the embeddings may be different I will check again}
These results coincide with the results in Section~\ref{sxn:cv} on CV models. 
