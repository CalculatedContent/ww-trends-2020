...
The ImageNet-1K models, and other models in section 6), are taken from the \textttr{omsr/imgclsmob}
...
\end{tabular}
\end{center}
\caption{Jupyter notesbooks used to reproduce sections 4 and 5}
