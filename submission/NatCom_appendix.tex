...
In our github repository, we provide several python Juoyter Google Colab anotebooks,
as well as previously generated data,  which can be used to reproduce the results of Section~\ref{sxn:all_cv_models}, 
and using the \texttt{WeightWatcher} tool (version 0.2.7), as described in Table~\ref{table:notebooks}.
