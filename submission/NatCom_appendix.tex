...
Our final analysis includes 108 regressions in all. %, those with 4 or more models.%, with a positive $R^2$.
...
Log Spectral norm, %Avg. Log Spectral Norm $\langle\log\Vert\mathbf{W}\Vert^{2}_{\infty}\rangle$, 
...
In contrast, the 
Log Frobenius norm %Avg. Log Alpha Norm $\langle\log\Vert\mathbf{W}\Vert^{\alpha}_{\alpha}\rangle$, 
