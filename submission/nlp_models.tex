...
\michael{IS THERE A TYPO THERE, OR AM I MISSING SOMETHING.}
...
\michael{WE SHOULD PROBABLY REWORD, SINCE IT IS OPPOSITE OF GPT TO GPT2.}
...
\begin{figure}[htb]
    ...
    \caption{Histogram of PL exponents ($\alpha$)
             %Log Spectral norm ($\log\Vert\mathbf{W}\Vert_{\infty}$), 
              ...
              \michael{CAN WE HAVE OTHER FIGS, THEY WERE MORE VISUALLY COMPELLING.}
             }
