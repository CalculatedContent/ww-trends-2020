...
By comparing GPT2-medium to GPT2-large to GPT2-xl, we can examine the effect of increasing data set and model size simultaneously, as well as analyze well-trained versus \nred{very-well-trained} models.
...
We now look across series of increasingly improving GPT2 models (i.e., we consider well-trained versus \nred{very--well-trained} questions), by examining both the PL exponent $\alpha$ as well as the Log Norm metrics.  
...
versus \nred{very-well-trained} GTP2 models than between the poorly-trained versus well-trained GPT and GPT2-small models.
...
As expected, the norm metrics can indeed distinguish among well-trained versus \nred{very-well-trained} models among a series well-trained models.
