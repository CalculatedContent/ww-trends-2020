...
These model series are all very well-trodden, and thus our results indicate that norm-based metrics and PL-based metrics can both distinguish among a series of well-trained versus more-well-trained models, with PL-based metrics performing somewhat (i.e., quantitatively) better.
