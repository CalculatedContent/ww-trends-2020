...
\item
Norm-based meterics, howevver, may give spurious results, such as \emph{Scale\  Collapse} for poorly-trained modeles (i.e. models trained without enough data, etc.).  
\item 
