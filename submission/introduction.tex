...
\item 
PL-based metrics can be used to characterize fine-scale model properties (including layer-wise \emph{Correlation Flow}) in both well- and /or poorly-trained models), and can be used to evaluate enhancements (i.e. distillation, finetuning, etc.)
\end{itemize}
