...
Moreover, if ML is to become an industrial process, then that process will become \nred{comparmentalized in ortder to scale}: some groups will gather data, other groups will develop models, and other groups will use those models.
