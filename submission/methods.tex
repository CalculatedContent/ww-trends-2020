...
\end{equation}
\nred{the loss function $\mathcal{L}()$ can take on a myriad of forms\cite{Janocha2017}, and $E_{DNN}$ is what we call the Energy Landscape.}
