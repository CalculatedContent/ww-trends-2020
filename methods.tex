...
For the last two quantities, $\alpha$ is the PL exponent that arises in the recently-developed \emph{Theory of Heavy Tailed Self Regularization (HT-SR)}~\cite{MM18_TR, MM19_HTSR_ICML, MM20_SDM}.
...
For norm-based metrics, we consider the average log norm to the appropriate power.
For example, for the \emph{$\alpha$-Norm metric}, 
\begin{equation}
