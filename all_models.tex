...
\end{tabular}
\end{center}
\caption{Comparison of linear regression fits for different average log norm metrics across XX datasets, covering 228 different pretrained DNNs.  We only cinclude regressions for architecturs with 5 or more data points \charles{and which are postively correlated with the test error}.}
\label{table:nlp}
\end{table}
