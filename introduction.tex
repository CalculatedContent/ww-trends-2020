...
\nred{Instead, one may simply be given a model that has already been trained---a \emph{pretrained model}---and need to use it "as is'', or fine tune it and/or compress it.}
...
\nred{We have examined hundreds of models, we indentify the general trends, and highlight interesting exceptions.}
...
\footnote{\url{https://github.com/CalculatedContent/kdd2020} \michael{DIFFERENT NAME?}\charles{suggestions?}}
