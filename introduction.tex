...
\michael{Sentence or two about how our metrics come from norm-based SLT and alpha-based HT-SR theory, since that is also highlighted in the abstract.}

SOMEWHERE CITE WEIGHTWATCHER: \cite{weightwatcher_package}
